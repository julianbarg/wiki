...
On this document: the Background section introduces the KXL developments in 2015: from a bipartisan effort to greenlight the pipeline in congress in January, to presidential hopeful Hillary Clinton speaking out against KXL September, and in November TransCanada asking for the application to be suspended before the president rejects the permit application four days later. The developments throughout the year largely hinge on Hillary Clinton's stance on the issue, as perception slowly shifts and KXL emerges as a partisan issue. The section on KXL from a Clinton campaign perspective constitutes an inductive coding of the campaign team's emails on KXL.

## Data & methods

The approach taken in this study borrows heavily from @Hardy2020 as well as @Maguire2013. In the first stage of analysis I looked at the administrative history of the KXL application across it history of over ten years. I quickly noticed that KXL was discussed in parallel or consecutively on many different administrative levels and outside of the administrative system. To realize the KXL project, TransCanada would need to obtain *all of* the relevant permits, some of which needed to be renewed or were challenged again in court after some time. The most important events (as of late 2021) take place between August 2009 when TransCanada first applies for a permit in Canada, and January 2021, when KXL comes to a (preliminary?) end after the US president cancels the key permit. The process offers us the unique opportunity to analyse a discourse of national and international interest as a quasi-repeat sample. Hence, we can avoid sampling on the outcome, and view both the company's successful and unsuccessful attempts of securing permits. Using this repeat sample alleviates some of the concerns around "hypermascular" actors with high degrees of agency in the discourse literature [@Suddaby2017].

To facilitate the analysis of this quasi-repeat sample, in the second stage I created an event history database, with two goals. (1) The phenomena of interest are the various sub-discourses that this analysis treats as quasi-independent samples. (2) The analysis should avoid sampling on outcomes--i.e., institutional change--to avoid the abovementioned problem. An analysis that focuses solely on institutional change will necessarily yield data that accentuates the agency around this change. The event history database was created by obtaining agency news (Associate Press & Reuters) from Factiva. The keywords for the searc were "Keystone XL" in conjunction with "hearing" or "forum". Using agency news rather than newspaper articles has the advantage of yielding not only news of events with important outcomes, but also announcements of events that may later turn out not to be path-breaking and newsworthy [need more poignant wording?]. The resulting event history database contains [put specific number?] of public forums or arenas [@Latour2005] where individuals or organizations engaged in discourse without the outcome being "fixed" as constituting institutional change.

In the third stage, I compared the discursive process across the identified forums or arenas. It emerged that episodes with a clear status quo are resolved quickly, while the presence of uncertainty accounts for most of the delays or suspension in the process and explain the long duration of the overal permit application process--and the long duration of the [potential or realized? partial?] deinstitutionalization of large pipeline projects. [In a future version of this paragraph, there would be a table that I would be pointing to, and maybe drawing on]. Paradoxically, these open-ended processes also provide the most space for agentic action: in these spaces, two or more organizations exchange blows, which often cancel each other out.

Finally, I conducted an iterative, inductive coding of the episodes that feature a suspension of the permit approval process. [A future version of this paragraph would probably list a number of concepts I have identified across different episodes, and it would briefly summarize these concepts, maybe with a table.]
...
How did that change of hearts regarding KXL come to be? The leaked emails showcase how KXL continuously interferes with the Clinton campaign team's other policy goals. Hence, the team frequent considers the "logistics" of taking a stance in the KXl discourse. 

The following represents an inductive coding of the Clinton emails. What emerges are seven themes that are briefly summarized here and further explained in the following sections. **(1)** *Allies and adversaries* covers two camps of stakeholders. Environmental groups and labor unions both hope for the campaign team to adopting their opposing stance on KXL. The campaign team discusses their often direct requests as it seeks endorsements. **(2)** The campaign team discusses the *ongoing discourse* on KXL and other issues. Of major interest is the upcoming Keystone XL permit decision by the White House, which would provide the campaign team with an easy way out if the permit was denied. **(3)** The campaign team extensively discusses the *anticipated effect* of their hypothetical participation in discourse. This discussion of the anticipated request concerns context rather than content. **(4)** On a related note, at key moments the emails show reflection and *introspective*. Questions of identity, consistency with past statements, and outward appearance are closely tied together [Question: is this separate from but related to the last point? Are they the same? Are they more different than I let on?].

**(5)** *Reconciling* their position with that of other actors plays out in a more cynical fashion than the existing literature lets on [@Maguire2006]. The campaign team's emails contain deliberately transactional drafts of public statements. **(6)** The team monitors the position of *competitors*, another source of pressure for taking a specific position. **(7)** Some of the campaign members see *ambiguity* as a way to resolve their conundrum regarding Hillary Clinton's stance on KXL. The team considers ambiguous discursive actions after which Hillary Clinton may be perceived to take an anti-KXL position without spelling it out.
...
The merit of a public statment is contingent on the current state of the discourse. Throughout this episode, the campaign team expects a permit decision by the president in the near future. A negative permit decision would provide Hillary Clinton with an easy way out where she could point to the 'process' in support of a negative statement. A positive permit decision on the other hand could mean that the pipeline is a *fait accompli*, where again she could take a negative stance while again pointing to 'process'. In other words, timing matters where actors expect a change in state of afairs. And why should the campaign release a statement if--from their perspective--a much more favorable status quo is imminent, where Hillary Clinton can 'hide' behind the presidents decision and 'process'? Hence the short email by Brian Fallon, already quoted twice above, implying that the team might wait until "POTUS vetoes". John Podesta, in a similar vein: "Now if POTUS would finally kill Keystone all could be good in the kingdom". See further [[Table 2a on ongoign discourse|Clinton email tables#a-with-regard-to-the-kxl-permit-application]]. See [[Section Introspective|Application suspension episode#4-introspective]] for the Clinton campaign's eventual shift on the issue.

### 3. Anticipated effect

To participate in discourse is not as easy as drafting a statement and then releasing it. The Clinton campaign teams considerations indicate that the same statement, sent at different times of the week, can have very different effects. There is the obvious step of pushing the release of a statement back to take place after the meeting with key stakeholders, the building trades unions. Nikki Budzinski: "Ideally to get [taking a stance on KXL] passed [sic] the Sept 9 meeting with the Building trades would be a personal god-send [sic]". Even then, it is not as easy as just waiting until *after* the meeting. Nikki Budzinski again: "I have reservations on the aggressive rollout [sic] timed to the meeting. I think it might be more natural to let it sit for a day knowing that it could leak and do [the announcement] the next day". Besides concerns regarding the stakeholder and potential ally, the campaign teams considers the schedule of unrelated events. "Thursday would be better press-wise so [Hillary Clinton’s KXL announcement] doesn’t compete with her Iran speech on Wednesday." "We could even have her come out against Keystone on Monday as well (not sure where that stands), which will solicit criticism but that might help distract from [Hillary Clinton email controversy]." See further [[Table 3 on anticipated effect|Clinton email tables#3-anticipated-effect]].

Note: considerations of the anticipated effect and introspective are closely related. Introspective considers past statements and questions of identity in relation to outside appearance. Questions on anticipated effects are more concerned with characteristics of the external audience, such as the weekly media circles and release schedules. These two may be considered the two ends of a spectrum. On this spectrum, the following quote--which is related to the Hillary Clinton email controversy rather than to KXL--marks one end of the spectrum. Kristina Schake: "Just talked to Podesta - we are thinking we shouldn’t put out the statement at this point because it is so late in day on a Friday the press is bound to respond negatively[...]." [This point might deserve some further development?]

### 4. Introspective

Besides the timing--or rather the decision on action or inaction--the content of discursive action is also subject to debate. A determinant factor proves to be not merit or the subject matter, but questions of consistency with past statements, of identity, or of how the statements will reflect on Hillary Clinton. Joel Benenson, chief strategist: "This op-ed [on KXL] makes her seem totally political. Her reason for being against it is because 'she can't stay silent on an issue that matters to so many\'?\? [sic] She has been silent. I don’t think this construct will fly.". The perceived shift, from 'inclined' to approve, to not interfering with a process that she initiated (see [[Section Ambiguity|Application suspension episode#7-strategic-use-of-ambiguity]]), to finally coming out against KXL is the biggest challenge to the campaign. Jim Margolis, Senior media advisor: "[What Brian Fallon pointed out] has been bothering me as well. We repeatedly said we couldn’t [take a stance on KXL] and then launch an op Ed [sic] without much explanation." Taking an honest stance on KLX proves to be unworkable: 
...
See further [[Table 5 on reconciling|Clinton email tables#5-reconciling]].
...
In the discourse on KXL, the Clinton campaign team often views ambiguity not as a flaw, but as a feature. Early on, Jake Sullivan, Chief foreign policy advisor indicates that he would like to avoid for Hillary Clinton to take a stance in person, in order to avoid the questions on this shift: "[I]f we want to have [Hillary Clinton] express skepticism [on KXL] we can do so through a [spokesperson] answer to question, using our Q[&]A". The team also discusses taking advantage of the fact that Campaign chair John Podesta is a well-known KXL opponent. When Time Magazine sends a press question regarding his role in advising Hillary Clinton on KXL, Brian Fallon quickly comes up with a way of signaling without committing: "option 3 - lean into this to send a wink-wink to enviros while [Hillary Clinton] continues to give her non-answer" [@Ferguson2015]. In the public, Hillary Clinton recuses herself: "I am not going to second guess [President Barack Obama] because I was in a position to set this in motion" [@Merica2015a]. Dan Schwerin, Director of speechwriting summarizes the campaign's strategy in the following fashion: "We are trying to find a good way to leak her opposition to the pipeline without her having to actually say it and give up her principled stand about not second-guessing the President in public". Eventually, the campaign team lands on the following language to sidestep the question for another week. Hillary Clinton: "I have been waiting for the administration to make a decision. I thought I owed them that. [...] I can't wait too much longer. I am putting the White House on notice. I am going to tell you what I think soon because I can't wait" [@Merica2015]. Even this fairly ambiguous stance presents a challenge for some on the campaign team. John Podesta writes in an email to somebody in th White House: "Trying to calibrate whether we are threading the needle ok with you guys after Valerie [Alexander] getting her nose out of joint on Keystone [with her announcement of 'putting the White House on notice']. (She watches too much Morning Joe by the way; they are the only people who viewed her comments on being frustrated with the delay [of the permit decision] as a frontal attack on POTUS.)" See further [[Table 7 on Ambiguity|Clinton email tables#7-ambiguity]].

## Discussion

The inductive coding of the Clinton emails on KXL revealed seven dimensions that the campaign team considered before partaking in discourse. The temporal dimensions has been omitted from this analysis, which to some degree is inconsequential as the dimensions largely play out in parallel. The only exception are *reconciling* and *introspective*, which are only engaged respectively when the decision to take an anti-KXL stance has largely been made and when the statement is being drafted. Altogether, these inductive codes account for the suspension of the Clinton campaign's participation in the KXL discourse, which in turn accounts partially for the "stalemate year" of 2015. 

The prior episode on Nebraska featured a strong element of interaction. The court battle in particular was a response of one party to another parties attempt of sidestepping the discourse. In this episode, an interactive element is present again, although we view the events mostly from one point of view, and the pair of action and reaction is mostly omitted with the temporal perspective. The interactive element is most salient in the campaign team's consideration for potential *allies and adversaries*. The team considers these external actors' demands further as it seeks to *reconcile*. The teams attention to the *ongoing discourse* highlights the (unrealized) potential for interaction with the White House. The *anticipated effect* shows some concern for the media as an important mediator, and *competitors* put additional pressure on the campaign team. Consider this thought experiment that highlights the interactive element: one could put the Clinton campaign team side by side with the goals and considerations of the other actors. Environmental groups like the League of Conservation Voters consider how to put targeted pressure on the Clinton campaign team. The labor unions may consider what *reconciliations* to accept. The White House may have considered the interests of the Clinton campaign team when laying out a time line for the KXL permit approval process. For instance, the White House could have hurried the process to help out the Clinton campaign. The number of interactions is seemingly endless, which highlights the strong element of randomness--and, paradoxically, the opportunities for agentic intervention--over a short run in discourse. Unfortunately, the inside perspective on most of these actors at this time is not available to further study these potential interactions.
...
Hillary Clinton | D     | Presidential nominee  |       | July  | 27    | Hillary Clinton recuses herself
Chris Christie  | R     | Candidate             |       |       | 29    | States if he was the president "[w]e'd build it" [@Hayes2015]
...
</br>|       | 27   | Clinton articulates her provisional stance: "I am not going to second guess (President Barack Obama) because I was in a position to set this in motion. […] I want to wait and see what he and Secretary Kerry decide. […] If it is undecided when I become president, I will answer your question" [@Merica2015a].
