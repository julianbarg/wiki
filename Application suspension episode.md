...
TransCanada's request for the application to be suspended higlights TransCanada's agency in the discourse beyond the provision of narratives, beyond translation, and beyond reconciliation and challenging of the existing discourse. TransCanada's permit application exists in a network of actors with different goals and interests. Throughout the year 2015, the field of candidates for the 2016 presidential election became increasingly clear. The 2015 Keystone XL Pipeline Approval Act could be taken as a litmus test. On January 9, 2015 the House of Congress passed the act with votes from 238 Republicans and 28 Democrats. In 
