...
The above section lays out the field of potential intervenors from the perspective of TransCanada. For some period of time, the major source of uncertainty is the Clinton campaign--the only party in the cohort not to take a position. In 2016 the world received some insight into why that is when WikiLeaks released thousands of her campaigns emails. From the emails we can learn about the network of coalitions that affect the Clinton campaign's *discursive actions*. 
